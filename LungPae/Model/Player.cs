...
namespace LungPae.Model
{
    internal class Player 
    {
        ...
        internal void Drawmini(SpriteBatch _spriteBatch,Vector2 Playerpos) // Drawสำหรับminigame
        {
            player.DrawFrame(_spriteBatch, Playerpos , row);
